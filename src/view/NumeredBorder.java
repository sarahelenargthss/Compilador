...
/**
 *
 * @author fabiofalci Disponível em:
 * https://www.guj.com.br/t/exibir-numero-da-linha-em-jtextarea/53062/2
 */
public class NumeredBorder extends AbstractBorder {
    ...
    public NumeredBorder() {
        this.myColor = new Color(1, 112, 158);
    }
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        for (; i < rows; i++) {
            ...
            px = this.characterWidth * lenght + 4;
            //px += point.x;

            g.drawString("  " + str, px, py);
        }
        int left = this.calculateLeft(height) + 10;
        //left += point.x;
    ...
    public Insets getBorderInsets(Component c) {
        int left = this.calculateLeft(c.getHeight()) + 15;
